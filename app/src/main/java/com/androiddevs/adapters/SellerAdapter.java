...
public class SellerAdapter extends RecyclerView.Adapter<SellerAdapter.RecyclerViewViewHolder> {
    ...
    public SellerAdapter(Context ctx, List<ViewSellerModel> mSellPropertyModelList) {
        this.ctx = ctx;
